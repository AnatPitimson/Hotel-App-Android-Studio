...
public class RoomWithSeaView extends Activity  implements AdapterView.OnItemSelectedListener
{
    int displayPic=1;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_with_sea_view);
        ...
        buttonApple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(RoomWithSeaView.this,chooseBedType,Toast.LENGTH_LONG).show();
                }
                else {
        ...
        ImageButton rightBtn=findViewById(R.id.right_btnSea);
        ...
        ImageButton leftBtn=findViewById(R.id.leftBtnSea);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(RoomWithSeaView.this, SecondPage.class);
    ...
    private void setImage() {
        switch (displayPic) {
            case 1:
                imageView.setImageResource(R.drawable.sea1);
                break;
            case 2:
                imageView.setImageResource(R.drawable.sea2);
                break;
            case 3:
                imageView.setImageResource(R.drawable.sea3);
                break;
            case 4:
                imageView.setImageResource(R.drawable.sea4);
                break;
            case 5:
                imageView.setImageResource(R.drawable.sea5);
                break;
        }
    }
